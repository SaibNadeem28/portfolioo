      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Web Developer | Meta Certified, Front-end Development
          </p>
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 text-white"
              style={{ background: 'linear-gradient(to bottom, rgb(15, 32, 128), rgb(169, 169, 169))' }}
            >
              Hire Me
            </Link>
            <Link
